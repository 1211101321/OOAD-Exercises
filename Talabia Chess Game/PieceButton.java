...
public class PieceButton extends JButton {
    ...
    */
    public void setSelected(String player) { 
        if (piece != null && piece.getColour().equals(player)) { //selects only if its colour mastches player tile will light up
            this.selected = true;
            this.setBackground(selectedColour);
        }
        else if (piece == null) {
            this.selected = true; //selects but no backgroundf colour change
        }
    }
}
